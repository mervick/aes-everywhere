...
var CryptoJS = require('node-cryptojs-aes/lib/core').CryptoJS;
require('node-cryptojs-aes/lib/enc-base64');
require('node-cryptojs-aes/lib/md5');
require('node-cryptojs-aes/lib/evpkdf');
require('node-cryptojs-aes/lib/cipher-core');
require('node-cryptojs-aes/lib/aes');
// const CryptoJS = require('node-cryptojs-aes').CryptoJS;

const ConcatFormat = {
    stringify(params) {
        return params.salt.toString() + params.iv.toString() +
            params.ciphertext.toString(CryptoJS.enc.Base64);
    },
    parse(str) {
...
},{"node-cryptojs-aes/lib/aes":3,"node-cryptojs-aes/lib/cipher-core":4,"node-cryptojs-aes/lib/core":5,"node-cryptojs-aes/lib/enc-base64":6,"node-cryptojs-aes/lib/evpkdf":7,"node-cryptojs-aes/lib/md5":8}],2:[function(require,module,exports){

const aes = require('./aes256.js').AES256;

console.log(aes);
},{"./aes256.js":1}],3:[function(require,module,exports){
